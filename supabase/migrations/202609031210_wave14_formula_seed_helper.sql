-- Web Empire wave 14 helper for deterministic bilingual formula tools.
-- GitHub staging only. Removed by the wave14 cleanup migration.
create or replace function public._wave14_upsert_formula_tools(p_category_slug text,p_tools jsonb)
