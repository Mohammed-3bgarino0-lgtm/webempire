-- Web Empire wave 10 helper for staged deterministic formula tools.
-- GitHub staging only. Removed by the wave10 cleanup migration.
create or replace function public._wave10_upsert_formula_tools(p_category_slug text,p_tools jsonb)
