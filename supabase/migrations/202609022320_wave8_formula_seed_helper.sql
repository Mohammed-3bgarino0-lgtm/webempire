-- Web Empire wave 8 helper for staged deterministic formula tools.
-- GitHub staging only. Removed by the wave8 cleanup migration.
create or replace function public._wave8_upsert_formula_tools(p_category_slug text,p_tools jsonb)
