-- Web Empire wave 5 helper for staged deterministic formula tools.
-- GitHub staging only. Removed by the wave5 cleanup migration after sector seeds run.
create or replace function public._wave5_upsert_formula_tools(p_category_slug text,p_tools jsonb)
