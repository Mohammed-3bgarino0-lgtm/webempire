-- Web Empire wave 11 helper for staged deterministic formula tools.
-- GitHub staging only. Removed by the wave11 cleanup migration.
create or replace function public._wave11_upsert_formula_tools(p_category_slug text,p_tools jsonb)
