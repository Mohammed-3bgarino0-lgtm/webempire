-- Web Empire wave 13 helper for deterministic bilingual formula tools.
-- GitHub staging only. Removed by the wave13 cleanup migration.
create or replace function public._wave13_upsert_formula_tools(p_category_slug text,p_tools jsonb)
