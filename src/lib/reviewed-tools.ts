...
import { INDEXING_WAVE_6_TOOL_SLUGS } from "@/lib/indexing-wave6-tools";
import { INDEXING_WAVE_7_TOOL_SLUGS } from "@/lib/indexing-wave7-tools";
import { INDEXING_WAVE_8_TOOL_SLUGS } from "@/lib/indexing-wave8-tools";
import { INDEXING_WAVE_9_TOOL_SLUGS } from "@/lib/indexing-wave9-tools";
import { INDEXING_WAVE_10_TOOL_SLUGS } from "@/lib/indexing-wave10-tools";
import { INDEXING_WAVE_11_TOOL_SLUGS } from "@/lib/indexing-wave11-tools";
import { INDEXING_WAVE_12_TOOL_SLUGS } from "@/lib/indexing-wave12-tools";
import { INDEXING_WAVE_13_TOOL_SLUGS } from "@/lib/indexing-wave13-tools";
...
export const INDEXABLE_PUBLIC_TOOL_SLUGS = [
  ...
  ...INDEXING_WAVE_6_TOOL_SLUGS,
  ...INDEXING_WAVE_7_TOOL_SLUGS,
  ...INDEXING_WAVE_8_TOOL_SLUGS,
  ...INDEXING_WAVE_9_TOOL_SLUGS,
  ...INDEXING_WAVE_10_TOOL_SLUGS,
  ...INDEXING_WAVE_11_TOOL_SLUGS,
  ...INDEXING_WAVE_12_TOOL_SLUGS,
  ...INDEXING_WAVE_13_TOOL_SLUGS,
] as const;
