...
const copy = {
  ar: {
    ...
    intro:
      "توضح هذه السياسة نوع البيانات التي تجمعها إمبراطورية الويب، وكيف نستخدمها ونحميها، والخيارات المتاحة لك عند استخدام الحساب والأدوات والاشتراكات.",
    ...
    sections: [
      {
        ...
        items: [
          ...
          "بيانات الاشتراك والفوترة مثل الخطة وحالة الاشتراك ومعرّفات المعاملات والعملاء لدى مزود الدفع.",
          "بيانات الاستخدام مثل الأدوات التي يتم تشغيلها، وقت التشغيل، عدد النقاط المستخدمة، وحالة الطلب.",
          ...
          "الرسائل التي ترسلها إلى الدعم أو التواصل أو طلبات الاسترداد.",
        ],
      },
      {
        ...
        items: [
          ...
          "إدارة الاشتراكات وتأكيد المدفوعات والتجديدات والإلغاءات.",
      ...
      {
        title: "3. بيانات الدفع",
        paragraphs: [
          "تتم معالجة المدفوعات والفواتير بواسطة Paddle. لا تخزن إمبراطورية الويب رقم البطاقة الكامل أو رمز الحماية. قد نستلم من مزود الدفع بيانات محدودة مثل معرّف العميل والمعاملة والاشتراك وحالة الدفع وبلد الفوترة والمبلغ.",
        ],
      },
      {
        title: "4. المحتوى المرسل إلى الأدوات",
        paragraphs: [
          "نستخدم المحتوى الذي ترسله فقط لتنفيذ الأداة المطلوبة، وحماية الخدمة، ومعالجة الأخطاء عند الحاجة. يجب ألا ترفع معلومات سرية أو شخصية لا تملك حق معالجتها. وقد تعتمد بعض الأدوات على مزودي ذكاء اصطناعي أو بنية سحابية خارجية لتنفيذ الطلب.",
        ],
      },
      {
        title: "5. مشاركة البيانات",
        paragraphs: [
          "لا نبيع بيانات المستخدمين. قد نشارك الحد الأدنى اللازم من البيانات مع مزودي الاستضافة وقواعد البيانات والبريد والتحليلات والذكاء الاصطناعي والدفع والدعم، أو مع الجهات المختصة عندما يوجب النظام ذلك.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "نحتفظ بالبيانات للمدة اللازمة لتقديم الخدمة والوفاء بالالتزامات المحاسبية والأمنية والنظامية وتسوية النزاعات. وقد نحذف أو نخفي هوية بعض البيانات عندما لا تعود الحاجة قائمة إليها.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "قد تتم معالجة بعض البيانات في دول توجد فيها شركات الاستضافة أو الدفع أو الذكاء الاصطناعي. نختار مزودين موثوقين ونسعى إلى تطبيق الضمانات المناسبة وفق الأنظمة المعمول بها.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          "We may collect account information, subscription records, tool usage, submitted content, technical logs, and support communications.",
        ],
      },
      {
        title: "How we use data",
        paragraphs: [
          "We use data to operate accounts and tools, process subscriptions, provide support, improve security and performance, and meet legal obligations.",
        ],
      },
      {
        title: "Payments and service providers",
        paragraphs: [
          "Payments are processed by Paddle. Web Empire does not store complete card details. We may use trusted hosting, database, analytics, AI, email, and support providers.",
        ],
      },
      {
        title: "Your rights",
