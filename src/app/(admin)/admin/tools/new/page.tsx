...
export default async function NewToolPage() {
  ...
  const [categoriesResult, skillsResult, connectionsResult, workflowsResult] = await Promise.all([
  ...
  return (
    <>
      <div className="admin-head">
        ...
        <p>أنشئ الواجهة والمحرك والمهارات وإعدادات SEO بدون تحرير JSON يدويًا.</p>
      </div>
      <VisualToolBuilder
